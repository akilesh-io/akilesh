      ...
      <div className={`flex justify-center ${workPath ? 'pt-4' : 'sm:pb-4 pb-16 '}`}>
        ...
        >
          <svg
            ...
            <path fill-rule="evenodd" clip-rule="evenodd" d="M16.1061 58.3111C20.5381 35.6959 43.5855 23.2062 62.4346 28.3436L61.0692 33.3513C45.0687 28.9903 25.0407 39.714 21.2006 59.3091L16.1061 58.3111Z" />
          </svg>
